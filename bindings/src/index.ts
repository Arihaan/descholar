...
export const networks = {
  testnet: {
    ...
    contractId: "CA6YKTUFN2R6APIPTLCX2NRUNBZQWHRNMXW2UJXGPHDVKOGHVJKWNXS5",
  },
} as const;
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "AAAAAQAAAAAAAAAAAAAAC1NjaG9sYXJzaGlwAAAAAAUAAAAAAAAAEGF2YWlsYWJsZV9ncmFudHMAAAAEAAAAAAAAAAdkZXRhaWxzAAAAABAAAAAAAAAACGVuZF9kYXRlAAAABgAAAAAAAAAEbmFtZQAAABAAAAAAAAAAEnRvdGFsX2dyYW50X2Ftb3VudAAAAAAACw==",
